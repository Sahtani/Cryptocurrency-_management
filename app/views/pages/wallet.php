...
// require APPROOT . '/libraries/Walletss.php';
...
<body class="bg-white text-white font-sans">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            // Assuming data is passed from your controller
            var cryptoNames = <?php echo json_encode($data['cryptoNames']); ?>;
            var quantities = <?php echo json_encode($data['quantities']); ?>;
