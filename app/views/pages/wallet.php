            ...
            <div class="flex flex-col min-w-0 flex-1 overflow-hidden">
                ...
                <main>
                    ...
                    <div class="flex justify-around my-4">
                        ...
                        <button data-modal-target="crud-modal" onclick="clickBuyBtn(event)" data-modal-toggle="crud-modal" name="submit" class=" buy_btn bg-[#db2777] text-white rounded py-2 px-4">Sell</button>
...
<div id="crud-modal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
          <div class="relative p-4 w-full max-w-md max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow">
              ...
              <!-- Modal body -->
              <form class="p-4 md:p-5" action="<?php echo URLROOT; ?>/Wallets/sell" method="post">
                <div class="grid gap-4 mb-4">
                 
                  <div class="col-span-2 sm:col-span-1">
                                        <label for="category" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Category</label>
                                        <select id="crypto" name="crypto" class="bg-gray-50 border border-gray-400 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                                            <option selected="">Select cryptocurrency</option>
                                            <?php
                                            foreach ($data['coins'] as $crypto) {
                                                echo "<option value='" . $crypto->CryptomonnaieID . "'>" . $crypto->nom . "</option>";
                  ...
                  <div class="col-span-2 sm:col-span-1">
                    ...
                    <input type="number" name="Quant" id="Quant" min="1" value="1" class="bg-white border focus:outline-none border-gray-400 text-gray-900 text-sm rounded-lg  block w-full p-2.5 dark:border-gray-500 dark:placeholder-gray-400  " placeholder="" required="">
                ...
                <div class="flex items-center justify-center ">
                  ...
                  <button name="sell" type="submit" class="text-white inline-flex items-center bg-pink-600 focus:outline-none  font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-pink-600 dark:hover:bg-pink-700 ">
                    Sell
                  </button>
                </div>
              </form>
