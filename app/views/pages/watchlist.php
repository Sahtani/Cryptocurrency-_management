                      ...
                      <div class="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
                        <nav aria-label="Sidebar" class="mt-5">
                          <div class="px-2 space-y-1">
                            ...
                            <a href="#"
                              class=" bg-gray-100 text-gray-600 hover:bg-gray-50 hover:text-gray-900 group flex items-center px-2 py-2 text-base font-medium rounded-md"
                          ...
                          <div class="flex-1 flex flex-col  pb-4 overflow-y-auto">
                            ...
                            <nav class=" flex-1 bg-gray-900 pt-5" aria-label="Sidebar">
                              <div class="px-2 space-y-1">
                                ...
                                <a href="#"
                                  class=" bg-gray-200 text-gray-900  hover:bg-gray-50 hover:text-gray-900 group flex items-center px-2 py-2 text-sm font-medium rounded-md"
                                    ...
                                    <table class="min-w-full divide-y divide-gray-300">
                                      <thead class="bg-gray-50">
                                        <tr>
                                          ...
                                          <th scope="col"
                                            class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Max Supply
                                          </th>
                                          <th scope="col"
                                            class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Current
                                            Price</th>
                                          <th scope="col"
                                            class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Ranking
                                          </th>
                                          <th scope="col"
                                            class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Market Cap
                                          </th>
                                          <th scope="col"
                                            class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Volume 24h
                                          </th>
                                          <th scope="col"
                                      ...
                                      <tbody class="divide-y divide-gray-200 bg-white">
                                        ...
                                        foreach ($data as $coin) { ?>
                                          <tr>
                                            <td
                                              class="whitespace-nowrap px-3 py-4 text-sm text-gray-500 flex items-center ">
                                            ...
                                            <td
                                              ...
                                              <a href="#"
                                                class="inline-block px-2 py-1 text-sm font-medium tracking-wide text-center text-white transition duration-200  bg-pink-600 hover:bg-gray-900 ease rounded">Buy</a>
                                            </td>
                                          <?php } ?>
                                    </table>
                                  </div>
