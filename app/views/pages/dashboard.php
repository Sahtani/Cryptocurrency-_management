    ...
    <div class="flex flex-col flex-wrap items-center justify-between h-14 mx-auto md:flex-row max-w-7xl">
      ...
      <div class="inline-flex items-center justify-center h-full md:justify-end">
        <a href="<?php echo URLROOT; ?>/users/logout"
          class="inline-flex items-center justify-center h-full px-4 text-base font-medium leading-6 text-white whitespace-no-wrap transition duration-150 ease-in-out bg-pink-600 border border-transparent hover:bg-pink-500 focus:outline-none focus:border-pink-700 focus:shadow-outline-indigo active:bg-pink-700">
          Logout
        </a>
      </div>
    </div>
            ...
            <nav aria-label="Sidebar" class="mt-5">
              <div class="px-2 space-y-1">
                ...
                <a href="<?php echo URLROOT; ?>pages/watchlist"
                  ...
                  <svg class="text-gray-400 group-hover:text-gray-500 mr-4 h-6 w-6" xmlns="http://www.w3.org/2000/svg"
                ...
                <a href="<?php echo URLROOT ?>/watchlist/displayCrypto"
                ...
                <a href="<?php echo URLROOT; ?>/pages/wallet"
                  class="text-gray-600 hover:bg-gray-50 hover:text-gray-900 group flex items-center px-2 py-2 text-base font-medium rounded-md"
                  x-state-description="undefined: &quot;bg-gray-100 text-gray-900&quot;, undefined: &quot;text-gray-600 hover:bg-gray-50 hover:text-gray-900&quot;">
                  <svg class="text-gray-400 group-hover:text-gray-500 mr-4 h-6 w-6" xmlns="http://www.w3.org/2000/svg"
                    height="16" width="18" viewBox="0 0 576 512">
            ...
            <div class="flex-1 flex flex-col  pb-4 overflow-y-auto">
              ...
              <nav class=" flex-1 bg-gray-900 pt-5" aria-label="Sidebar">
                <div class="px-2 space-y-1">
                  ...
                  <a href="<?php echo URLROOT; ?>/wallet/index"
                    class="text-gray-600 hover:bg-gray-50 hover:text-gray-900 group flex items-center px-2 py-2 text-sm font-medium rounded-md"
                    x-state-description="undefined: &quot;bg-gray-200 text-gray-900&quot;, undefined: &quot;text-gray-600 hover:bg-gray-50 hover:text-gray-900&quot;">
                    <svg class="text-gray-400 group-hover:text-gray-500 mr-3 h-6 w-6" xmlns="http://www.w3.org/2000/svg"
                      height="16" width="18" viewBox="0 0 576 512">
                            ...
                            <thead>
                              <tr>
                                ...
                                <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">
                                  Ranking</th>
                                <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Image
                                </th>
                                ...
                                <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Market
                                  Cap</th>
                                <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Volume
                                  24h</th>
                                ...
                                <tr>
                                  ...
                                  <td
                                    ...
                                    <button data-modal-target="crud-modal" data-modal-toggle="crud-modal"
                                      class="block text-white bg-pink-600 hover:bg-pink-700 font-medium rounded-lg text-sm px-5 py-2.5 text-center "
              ...
              <form class="p-4 md:p-5" action="<?php echo URLROOT; ?>/wallet/buy" method="post">
                <div class="grid gap-4 mb-4 grid-cols-2">
                  <div class="col-span-2">
                    ...
                    <input type="text" name="name_crypto" id="name"
                      class="bg-white border focus:outline-none border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 dark:bg-white dark:border-gray-500 dark:placeholder-gray-400 "
                  ...
                  <div class="col-span-2 sm:col-span-1">
                    ...
                    <input type="number" name="price" id="price"
                      class="bg-white border focus:outline-none border-gray-300 text-gray-900 text-sm rounded-lg  block w-full p-2.5 dark:border-gray-500 dark:placeholder-gray-400   "
                ...
                <div class="flex items-center justify-center ">
                  ...
                  <button name="submit_buy" type="submit"
                    class="text-white inline-flex items-center bg-pink-600 focus:outline-none  font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-pink-600 dark:hover:bg-pink-700 ">
