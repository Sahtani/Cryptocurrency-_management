                          ...
                          <table class="min-w-full divide-y divide-gray-300">
                            <thead class="bg-gray-50">
                              <tr>
                                ...
                                <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Slug
                                </th>
                            ...
                            <tbody class="divide-y divide-gray-200 bg-white">
                              <?php foreach ($data as $coin) { ?>
                                <tr>
                                  <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500 flex items-center "><svg
                                      class="inline-block cursor-pointer mr-4" xmlns="http://www.w3.org/2000/svg"
                                      height="16" width="18" viewBox="0 0 576 512">
                                      <path fill="#87898c"
